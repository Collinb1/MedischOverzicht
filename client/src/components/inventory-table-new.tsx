                  ...
                  onError={(e) => {
                    ...
                    if (!target.src.includes('storage.googleapis.com') && item.photoUrl) {
                      ...
                      if (!existingPlaceholder) {
                        ...
                        content.className = 'text-center text-gray-500';
                        ...
                        path.setAttribute('d', 'M28 8H12a4 4 0 00-4 4v20m32-12v8m0 0v8a4 4 0 01-4 4H12a4 4 0 01-4-4v-4m32-4l-3.172-3.172a4 4 0 00-5.656 0L28 28M8 32l9.172-9.172a4 4 0 015.656 0L28 28m0 0l4 4m4-24h8m-4-4v8m-12 4h.02');
                        ...
                        mainText.className = 'text-sm mt-2';
                        mainText.textContent = 'Foto kan niet worden geladen';
                        
                        const fileText = document.createElement('p');
                        fileText.className = 'text-xs text-gray-400';
                        // Safe text content - no HTML injection possible
                        fileText.textContent = item.photoUrl?.split('/').pop() || 'Onbekend';

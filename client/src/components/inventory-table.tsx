...
const cabinetColors = {
  A: "bg-cabinet-a bg-opacity-20 text-cabinet-a",
  B: "bg-cabinet-b bg-opacity-20 text-cabinet-b", 
  C: "bg-cabinet-c bg-opacity-20 text-cabinet-c",
  D: "bg-cabinet-d bg-opacity-20 text-cabinet-d",
  E: "bg-cabinet-e bg-opacity-20 text-cabinet-e"
};
